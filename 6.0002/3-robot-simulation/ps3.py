...
# Time:
# Unable to finish: Test file errors due to deprecated imports 
# Completed [1,3) but can't test them  
...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.dirt_amount = float(dirt_amount)
        self.tiles = {}
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
        x_lower, y_lower = int(pos.get_x()), int(pos.get_y())
        original = self.room[y_lower][x_lower]
        if original-capacity<= 0 : cleaned = original - capacity
        else: cleaned = 0 
        self.tiles[(x_lower, y_lower)] = cleaned 
    ...
    def get_num_cleaned_tiles(self):
        ...
        for y in range(int(self.height)):
            for x in range(int(self.width)): 
                if self.is_tile_cleaned(y, x): clean+=1
        return clean 
    ...
    def is_position_in_room(self, pos):
        ...
        if 0<=x<=self.width and 0<=y<self.height: return True 
        return False
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        self.position = Position(random.randint(0, self.room.width), random.randint(0, self.room.height)) 
...
class EmptyRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        Returns: True if pos is in the room, False otherwise.
        """
        self.is_position_in_room(pos)
        
    def get_random_position(self):
        """
        Returns: a Position object; a valid random position (inside the room).
        """
        return = Position(random.randint(0, self.room.width), random.randint(0, self.room.height)) 
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_tile_furnished(self, m, n):
        ...
        """
        return True if (m,n) in self.furniture_tiles else False
    ...
    def is_position_furnished(self, pos):
        ...
        """
        x_lower, y_lower = int(pos.get_x()), int(pos.get_y())
        return self.is_tile_furnished(x_lower, y_lower)
    ...
    def get_random_position(self):
        ...
        """
        if self.get_num_tiles() == self.get_num_cleaned_tiles(): return ValueError('No valid positions available')
        while True:
            position = Position(random.randint(0, self.room.width), random.randint(0, self.room.height)) 
            if is_position_valid(position): return position
